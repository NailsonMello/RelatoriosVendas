...
public class Pedidos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        act.setTitle("Faturados");
        DatabaseUtil.getDatabase();
        FirebaseApp.initializeApp(Pedidos.this);
        ...
        listafaturados = (RecyclerView) findViewById(R.id.listaFaturados);
    ...
    private void queryPonto(String date) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("faturados");
        query = mDatabase.orderByChild("data_emissao").startAt(date+"'").endAt(date+"'" + "\uf8ff");
        FirebaseRecyclerAdapter<FaturadosModel, Pedidos.AnuncioViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FaturadosModel, Pedidos.AnuncioViewHolder>
                (
                        FaturadosModel.class,
                        R.layout.layout_faturados,
                        Pedidos.AnuncioViewHolder.class,
                        query

                ){

            @Override
            protected void populateViewHolder(final Pedidos.AnuncioViewHolder viewHolder, final FaturadosModel model, int position) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_data){
            ...
            DatePickerDialog dialog = new DatePickerDialog(Pedidos.this,
